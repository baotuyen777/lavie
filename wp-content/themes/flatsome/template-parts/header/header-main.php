<div id="masthead" class="header-main <?php header_inner_class('main1'); ?>">
    <div class="header-inner  container <?php flatsome_logo_position(); ?>" role="navigation">
        <div class="flex">
            <!-- Logo -->
            ...
            <!-- Right Elements -->
            <div class="hide-for-medium search-box">
                <ul class="header-nav header-nav-main  <?php flatsome_nav_classes('main'); ?>">
